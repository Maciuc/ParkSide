    ...
    <section>
        <div class="row header-section align-items-center">
            ...
            <div class="col-auto">
                ...
                <AddPlayerHistoryComponent @get-list="GetAllPlayerHistories()" ref="addPlayerHistoryModal"></AddPlayerHistoryComponent>
            </div>
        </div>
            ...
            <div class="col-xxl-4 col-xl-4 col-lg-3 col-md-4 col-sm-6">
                <div class="input-group-custom mb-3 custom-control">
                    ...
                    <input type="text" class="form-control search" placeholder="Caută" aria-label="Username"
                        aria-describedby="basic-addon1" v-model="filter.SearchText" v-on:keyup.enter="GetAllPlayerHistories()" />
                </div>
            </div>

            <div class="col-xl-4 col-md-3 col-sm-4 mb-2 custom-date-picker">
                <!-- <VueDatePicker v-model="filter.PlayerHistoryDate" format="dd/MM/yyyy" auto-apply utc :enable-time-picker="false"
                    @update:model-value="GetAllPlayerHistories()" placeholder="Dată meci"></VueDatePicker> -->
                    <select
        ...
        <div style="overflow-x: auto">
            <table class="table table-custom">
                <thead>
                    <tr>
                        <th width="22%" @click="OrderBy('playerName')" class="cursor-pointer">
                ...
                <tbody>
                    <tr v-for="(playerHistory, index) in playerHistories.Items" :key="index">

                        <td>
                            <div class="d-flex align-items-center">
                                <div class="img-container-avatar me-3">
                                    <img :src="ShowDynamicImage(playerHistory.PlayerImageBase64)" class="me-2 icon-avatar" />
                                </div>
                                <span>{{ playerHistory.PlayerLastName + " " + playerHistory.PlayerFirstName }}</span>
                            </div>
                        </td>
                        <td>
                            <div class="d-flex align-items-center">
                                <div class="img-container-avatar me-3">
                                    <img :src="ShowDynamicImage(playerHistory.ChampionshipImageBase64)" class="me-2 icon-avatar" />
                                </div>
                        ...
                        <td>
                            <div class="editButtons">
                                <button class="button-edit" data-bs-toggle="modal" type="button"
                                    data-bs-target="#playerHistory-edit-modal" @click="GetPlayerHistoryForEdit(playerHistory.Id)">
                                    <font-awesome-icon :icon="['far', 'pen-to-square']" />
                                </button>

                                <button type="button" class="button-delete" @click="DeletePlayerHistory(playerHistory.Id)">
