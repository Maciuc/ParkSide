<template>
  ...
  <Form
    @submit="EditStuff(this.editedStuff.Number)"
    ...
    <div class="new-form">
      <div class="row mt-4">
        <div class="col-md-7 col-lg-5 col-12">
          <div class="mb-3">
            <label for="input-lastname-edit-stuff" class="form-label"
              >Nume</label
            >
            <Field
              type="text"
              ...
              id="input-lastname-edit-stuff"
              name="lastname"
              placeholder="Nume "
              v-model="editedStuff.LastName"
            />
            <ErrorMessage name="lastname" class="text-danger error-message" />
          </div>

          <div class="mb-3">
            <label for="input-firstname-edit-stuff" class="form-label"
              >Prenume</label
            >
            <Field
              type="text"
              ...
              id="input-firstname-edit-stuff"
              name="firstname"
              placeholder="Nume stuff"
              v-model="editedStuff.FirstName"
            />
          ...
          <div class="mb-3 position-relative">
            ...
            >
              ...
              <Field
                v-slot="{ field }"
                name="birthdate"
                id="birthdate-edit-stuff"
              >
                <VueDatePicker
                  v-bind="field"
                  v-model="editedStuff.BirthDate"
                  format="dd/MM/yyyy"
                  auto-apply
                  utc
          ...
          <div class="mb-3 position-relative">
            <label for="input-nationality-edit-stuff" class="form-label"
              >Nationalitate</label
            >
            <Field
              type="text"
          ...
          <div class="mb-3 position-relative">
            <label for="input-height-edit-stuff" class="form-label"
              >Inaltime</label
            >
            <Field
              type="text"
              class="form-control"
              id="input-height-edit-stuff"
              name="height"
              placeholder="Inaltime stuff"
              v-model="editedStuff.Height"
            />
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-md-7 col-lg-7 col-12">
          <div class="mb-3 position-relative">
            <label for="textarea-description-edit-project" class="form-label"
              >Descriere</label
            >
            <Field
              v-slot="{ field }"
              v-model="editedStuff.Description"
              name="description"
            >
              <textarea
                v-bind="field"
