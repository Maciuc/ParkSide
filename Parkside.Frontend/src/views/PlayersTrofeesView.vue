<template>
  <section>
    <div class="row header-section align-items-center">
      ...
      <div class="col-auto">
        ...
        <AddPlayerTrofeeComponent
          @get-list="GetAllPlayerTrofees()"
          ref="addPlayerTrofeeModal"
        >
        </AddPlayerTrofeeComponent>
      </div>
    </div>
          ...
          <tr v-for="(playerTrofee, index) in playerTrofees.Items" :key="index">
            <td>
              <div class="d-flex align-items-center">
                <div class="img-container-avatar me-3">
                  <img
                    :src="ShowDynamicImage(playerTrofee.PlayerImageBase64)"
                    class="me-2 icon-avatar"
                  />
                </div>
                <span>{{
                  playerTrofee.PlayerLastName +
                  " " +
                  playerTrofee.PlayerFirstName
                }}</span>
              </div>
            </td>
            <td>
              <div class="d-flex align-items-center">
                <div class="img-container-avatar me-3">
                  <img
                    :src="
                      ShowDynamicImage(playerTrofee.ChampionshipImageBase64)
                    "
                    class="me-2 icon-avatar"
                  />
                </div>
            ...
            <td>
              <div class="d-flex align-items-center">
                <div class="img-container-avatar me-3">
                  <img
                    :src="ShowDynamicImage(playerTrofee.TrofeeImageBase64)"
                    class="me-2 icon-avatar"
                  />
                </div>
            ...
            <td>
              <div class="editButtons">
                <button
                  type="button"
                  class="button-delete"
                  @click="DeletePlayerTrofee(playerTrofee.Id)"
                >
    ...
    <Pagination
      :totalPages="playerTrofees.NumberOfPages"
