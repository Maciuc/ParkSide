    ...
    <section>
        <div class="row header-section align-items-center">
            ...
            <div class="col-auto">
                ...
                <AddTrofeeModalComponent @get-list="GetAllTrofees()" ref="addTrofeeModal"></AddTrofeeModalComponent>
            </div>
        </div>
        ...
        <div class="row mt-3 new-form">
            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-4 col-sm-6">
                <div class="input-group-custom mb-3 custom-control">
                    ...
                    <input type="text" class="form-control search" placeholder="Caută trofeu" aria-label="Username"
                        aria-describedby="basic-addon1" v-model="filter.SearchText" v-on:keyup.enter="GetAllTrofees()" />
                </div>
            </div>
        </div>
                        ...
                        <td>
                            <div class="editButtons">
                                <button class="button-edit" data-bs-toggle="modal" type="button"
                                    data-bs-target="#trofee-edit-modal" @click="GetTrofeeForEdit(type.Id)">
                                    <font-awesome-icon :icon="['far', 'pen-to-square']" />
                                </button>

                                <button type="button" class="button-delete" @click="DeleteTrofee(type.Id)">
...
export default {
    ...
    methods: {
        ...
        GetAllTrofees(page) {
            ...
            this.$axios
                .get(
                    `api/Trofee/getTrofees?${new URLSearchParams(
                        searchParams
                    )}`
                )
                .then((response) => {
