    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title mt-2">Editeaza meci</h5>
          <button
            type="button"
            class="btn-close"
        ...
        >
          <div class="modal-body new-form">
            ...
            <div class="mb-3">
              <label for="input-mainpoints" class="form-label"
                >Puncte CSU</label
              >
              <Field
                type="text"
                ...
                id="input-mainpoints"
                name="mainpoints"
                placeholder="Puncte CSU"
                v-model="editedMatch.MainTeamPoints"
              />
            </div>

            <div class="mb-3">
              <label for="input-enemypoints" class="form-label"
                >Puncte adversari</label
              >
              <Field
                type="text"
                class="form-control"
                id="input-enemypoints"
                name="enemypoints"
                placeholder="Puncte adversari"
...
export default {
  ...
  methods: {
    SaveMatch() {
      this.$axios
        .put(
          `/api/Match/updateMatch/${this.editedMatch.Id}/${this.editedMatch.EnemyTeam.Id}/${this.editedMatch.Championship.Id}`,
          this.editedMatch
        )
        .then((response) => {
    ...
    ToggleHomePlay() {
      this.editedMatch.PlayingHome = !this.editedMatch.PlayingHome;
      console.log(this.editedMatch);
    },
    ToggleIsFinished() {
      this.editedMatch.IsFinished = !this.editedMatch.IsFinished;
      console.log(this.editedMatch);
    },
    ClearModal() {
