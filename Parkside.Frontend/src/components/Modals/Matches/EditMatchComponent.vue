<template>
        ...
        <div class="modal-content">
          ...
          >
            <div class="modal-body new-form">
              <div class="mb-3">
                <label for="input-title-edit-match" class="form-label"
                  >Nume echipa</label
                >
                <Field
                  type="text"
                  ...
                  id="input-title-edit-match"
                  name="name"
                  placeholder="Nume echipa"
                  v-model="editedMatch.Name"
                />
              ...
              <div class="row">
                <div class="col-6 d-flex flex-column justify-content-center">
                  ...
                  >
                    ...
                    <Field
                      ...
                      style="display: none"
                      accept="image/*"
                      ref="uploadInputEditMatch"
                      @change="UploadImageMatchEdit"
                    >
                    </Field>
                  </label>
                </div>
                ...
                <div class="col-6">
                  ...
                  >
                    <div v-if="!editedMatch.ImageBase64">
                      <div
                    ...
                    <div v-if="editedMatch.ImageBase64" class="image">
                      <button
                        type="button"
                        class="button-delete"
                        @click="DeletePhoto"
  ...
  export default {
    ...
    methods: {
      SaveEditedMatch() {
        this.$axios
          .put(`/api/Match/updateMatch/${this.editedMatch.Id}`, this.editedMatch)
          .then((response) => {
        ...
        reader.onload = () => {
          if (reader.result.includes("image")) {
            if (file.size / 1024 < 15360) {
              ...
              this.editedMatch.Image = reader.result;
              selectedFile.value = "";
            } else {
      ...
      DeletePhoto() {
        this.$refs.uploadInputEditMatch.reset();
        this.editedMatch.Image = null;
        this.PhotoValidation = null;
      },
    },
