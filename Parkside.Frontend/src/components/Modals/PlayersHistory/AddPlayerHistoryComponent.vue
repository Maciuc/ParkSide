  ...
  >
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <Form
          @submit="AddPlayerHistory"
          :validation-schema="schema"
          v-slot="{ errors }"
          ref="addPlayerHistoryFormRef"
        >
...
export default {
  ...
  methods: {
    AddPlayerHistory() {
      this.$axios
        .post(
          `/api/PlayerHistory/createPlayerHistory/${this.selectedPlayer.Id}/${this.selectedChampionship.Id}`,
          this.newPlayerHistory
        )
        .then((response) => {
