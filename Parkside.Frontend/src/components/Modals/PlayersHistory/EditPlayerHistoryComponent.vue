        ...
        >
          <div class="modal-body new-form">
            ...
            <div class="mb-3 position-relative">
              ...
              <Field
                v-model="editedPlayerHistory.Year"
                name="year"
                as="select"
            ...
            <div class="mb-3 position-relative">
              ...
              <Field
                v-model="editedPlayerHistory.PlayerRole"
                name="role"
                as="select"
            ...
            <div class="mb-3 position-relative">
              ...
              <Field
                v-model="editedPlayerHistory.TeamName"
                name="team"
                as="select"
...
export default {
  ...
  methods: {
    EditPlayerHistory() {
      this.$axios
        .put(
          `/api/PlayerHistory/updatePlayerHistory/${this.editedPlayerHistory.Id}/${this.editedPlayerHistory.Player.Id}/${this.editedPlayerHistory.Championship.Id}`,
          this.editedPlayerHistory
        )
        .then((response) => {
