    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title mt-2">Adaugă trofeu</h5>
          <button
            type="button"
            class="btn-close"
        ...
        <Form
          ...
          v-slot="{ errors }"
          ref="addTrofeeFormRef"
        >
          <div class="modal-body new-form">
            <div class="mb-3">
              <label for="input-title-trofee-add" class="form-label"
                >Nume trofeu</label
              >
              <Field
                type="text"
                ...
                id="input-title-trofee-add"
                name="name"
                placeholder="Nume trofeu"
                v-model="newTrofee.Name"
              />
            ...
            <div class="row">
              <div class="col-6 d-flex flex-column justify-content-center">
                ...
                >
                  ...
                  <Field
                    type="file"
                    id="input-upload-add-trofee"
                    name="upload"
                    style="display: none"
                    accept="image/*"
                    ref="uploadInputAddTrofee"
                    @change="UploadImageTrofee"
                  >
                  </Field>
                </label>
              </div>
