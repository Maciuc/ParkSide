  ...
  >
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <Form
          @submit="SaveEditedTrofee"
          :validation-schema="schema"
          v-slot="{ errors }"
          ref="editTrofeeFormRef"
        >
          <div class="modal-body new-form">
            <div class="mb-3">
              <label for="input-title-edit-trofee" class="form-label"
                >Nume trofeu</label
              >
              <Field
                type="text"
              ...
              <div class="col-6 d-flex flex-column justify-content-center">
                ...
                >
                  ...
                  <Field
                    ...
                    style="display: none"
                    accept="image/*"
                    ref="uploadInputEditTrofee"
                    @change="UploadImageTrofeeEdit"
                  >
                  </Field>
                </label>
              </div>
...
export default {
  ...
  methods: {
    SaveEditedTrofee() {
      this.$axios
        .put(
          `/api/Trofee/updateTrofee/${this.editedTrofee.Id}`,
          this.editedTrofee
        )
        .then((response) => {
